...
// node_modules/@atlaskit/pragmatic-drag-and-drop/dist/esm/util/cache-first.js
...
var isFirefox = cacheFirst(function isFirefox2() {
  if (false) {
    return false;
  }
...
var isSafari = cacheFirst(function isSafari2() {
  if (false) {
    return false;
  }
...
(function fixSafari() {
  ...
  (0, import_bind_event_listener.bindAll)(
    window,
    [{
      type: "dragstart",
...
// node_modules/@atlaskit/pragmatic-drag-and-drop/dist/esm/util/fix-post-drag-pointer-bug.js
...
function makeAdapter(_ref) {
  var typeKey = _ref.typeKey, mount2 = _ref.mount, dispatchEventToSource2 = _ref.dispatchEventToSource, defaultDropEffect = _ref.defaultDropEffect;
...
var isAndroid = cacheFirst(function isAndroid2() {
...
var adapter = makeAdapter({
  ...
  mount: function mount(api) {
    return (0, import_bind_event_listener4.bind)(document, {
      type: "dragstart",
      listener: function listener(event) {
...
//# sourceMappingURL=chunk-ACGSFQQ3.js.map
